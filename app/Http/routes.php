...
//    Route::get('order/{config?}', '\Mews\Captcha\CaptchaController@getCaptcha')
    ->middleware('web');
    Route::controller('/payment/{query}', 'Adm\PaymentController'); 
    ...
    Route::controller('/send-sms', 'Adm\SmsController');
