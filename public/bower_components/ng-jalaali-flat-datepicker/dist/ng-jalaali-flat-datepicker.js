    ...
    function ngJalaaliFlatDatepickerDirective($templateCache, $compile, $document, datesCalculator) {
        ...
        return {
            ...
            link: function (scope, element, attrs, ngModel) {
                ...
                console.log('scope.config.maxDate' , scope.config.maxDate);
